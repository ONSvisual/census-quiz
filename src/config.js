...
export const questions = [
    ...
    },
    {
        ...
        "text": "What percentage of people aged 16 years and over in {place} have previously served in the UK armed forces (including reserves)?",
        "topic": "employment",
        "clashID": "armed_forces",
        "label": "percentage of people that have previously served in the UK armed forces",
        "unit": "%",
        "legendUnit": "%",
        "info": "This compared with {K04000001,armed_forces_perc, 1}% across England and Wales. This does not include people who were serving at the time of the census.",
        "formatVal": 1,
        "startVal": 0,
        "minVal": 0,
        "maxVal": 25
    ...
    },
    {
        ...
        "type": "slider",
        "key": "population_total",
        "text": "How many people lived in {place} in 2021, to the nearest 1,000?",
        "topic": "population",
        "clashID": "population",
        "label": "population to the nearest 1,000",
        "unit": " people",
        "formatVal": -3,
        "startVal": 0,
        "minVal": 0,
    ...
    },
    {
        ...
        "type": "sort",
        "key": "age_75plus_perc",
        "text": "Sort these areas by the percentage of people aged 75 years and over, highest to lowest.",
        "topic": "age",
        "clashID": "age",
        "unit": "%",
        "legendUnit": "%",
    ...
    },
    {
        ...
        "text": "Out of the following options, which was the largest age group in {place}?",
        "topic": "age",
        "label": "largest group",
        "unit": "%",
        "legendUnit": "%",
    ...
    },
    {
        ...
        "text": "For every 1,000 people in {place}, how many did not have a passport, according to Census 2021?",
        "topic": "households",
        "clashID": "residency_birth_language_nationality",
    ...
    },
    {
        ...
        "type": "multi_choice_cat",
        "key": [
            "passport_country_France_total",
            "passport_country_India_total",
            "passport_country_Ireland_total",
            "passport_country_Italy_total",
            "passport_country_Lithuania_total",
            "passport_country_Nigeria_total",
            "passport_country_Pakistan_total",
            "passport_country_Poland_total",
            "passport_country_Portugal_total",
            "passport_country_Romania_total",
            "passport_country_Spain_total",
            "passport_country_USA_total"
        ],
    ...
    },
    {
        ...
        "text": "Out of the following main languages, which was the most commonly spoken in {place}?",
        "topic": "households",
        "clashID": "residency_birth_language_nationality",
...
export const catLabels = {
    ...
    "language_Romanian_total": "Romanian",
