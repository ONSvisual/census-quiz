...
export const questions = [
    ...
    {
        "type": "slider",
        "key": ["religion_Noreligion", "religion_Muslim"],
        "keyText": ["having no religion", "being Muslim"],
        "text": "For every 1,000 people in {place} in 2021, how many described themselves as {keyText}?",
        "topic": "religion",
        "clashID": "religion_detail",
        "label": "the number of people out of 100 who identify as {keyText}",
        "info": "Across England and Wales, out of every 1,000 people, {K04000001,{key},0,1} identified as {keyText}. The Census question on religion is voluntary and {K04000001,religion_Religionnotstated,0,1} out of every thousand chose not to answer.",
        "formatVal": 1,
        "shiftVal": 1
    },
    {
        "type": "slider",
        "key": "religion_Muslim",
        "text": "For every 1,000 people in {place} in 2021, how many described themselves as being Muslim?",
        "topic": "religion",
        "clashID": "religion_detail",
    ...
    },
    {
        ...
        "text": "After Christianity, what was  the most common religion in {place}?",
        "topic": "religion",
    ...
    },
    {
        ...
        "info": "Overall, {K04000001,mock_hold_passport_total,1,-6} million usual residents in England and Wales ({K04000001,mock_hold_passport_perc,1}%) held at least one passport and {K04000001,mock_no_passport_total,-6} ({K04000001,mock_no_passport_perc,1}%) had no passport.",
        "formatVal": 1
    },
    {
        "type": "multi_choice_cat",
