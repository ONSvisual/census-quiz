...
export function makeEmbed(code) {
  return `<iframe id="censusquiz" src="https://www.ons.gov.uk/visualisations/censusquiz/" width="100%" height="600px" frameborder="0" allow="clipboard-write" allowfullscreen></iframe>
